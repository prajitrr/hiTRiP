...
def TRiP():
    ...
    if use_master_crop == "y":
        ...
        if not os.path.exists(master_crop_path_global) or skip_master:
            ...
            print(f"A file named {images_path}_crop.txt has been created in the experiment folder. PLEASE SAVE THE CROPPING COORDINATES IN THIS FILE. Once you have saved the coordinates, press + "\033[1m" + "Enter to continue." + "\033[1m")
