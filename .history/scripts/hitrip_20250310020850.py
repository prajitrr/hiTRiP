...
def TRiP():
    ...
    if use_master_crop == "y":
        ...
        if not os.path.exists(master_crop_path_global) or skip_master:
            ...
            print(f"Previous master crop file not found/not in use. A file named {images_path}_crop.txt has been created in the experiment folder. Please add coordinates to this file.")
