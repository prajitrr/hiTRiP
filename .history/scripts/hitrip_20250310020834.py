...
def TRiP():
    ...
    if use_master_crop == "y":
        ...
        if not os.path.exists(master_crop_path_global) or skip_master:
            ...
            print(f"Previous master crop file not found/not in use. A new master crop file has been created in the experiment folder, {images_path}_crop.txt. Please add coordinates to this file.")
